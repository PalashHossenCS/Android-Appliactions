...
public class MultipleDropDown extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multiple_drop_down);
...
//                            break;
        ...
        Button submitButton,smap;
        smap=findViewById(R.id.smap);//To display the selected State and District
        ...
        smap.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MultipleDropDown.this, Map.class);
        ...
        submitButton.setOnClickListener(v -> {
            if (selectedState.equals("Select Your State")) {
                Toast.makeText(MultipleDropDown.this, "Please select your state from the list", Toast.LENGTH_LONG).show();
                ...
                Toast.makeText(MultipleDropDown.this, "Please select your district from the list", Toast.LENGTH_LONG).show();
                ...
                Toast.makeText(MultipleDropDown.this, "Selected State: "+selectedState+"\nSelected District: "+selectedDistrict, Toast.LENGTH_LONG).show();
            }
        });
    }
}